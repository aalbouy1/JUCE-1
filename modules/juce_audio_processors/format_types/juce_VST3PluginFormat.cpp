...
public:
    ...
    void prepareToPlay (double newSampleRate, int estimatedSamplesPerBlock) override
    {
        ...
        cachedBusLayouts = getBusLayouts();
    ...
    bool isBusLayoutSupported (const AudioBusLayouts& layouts) const override
    {
        ...
        if (! isActive)
            return canApplyBusLayouts (layouts);
    ...
    bool syncBusLayouts (const AudioBusLayouts& layouts) const
    {
        for (int dir = 0; dir < 2; ++dir)
        {
            const bool isInput = (dir == 0);
...
private:
    ...
    */
    ...
    AudioProcessor::AudioBusLayouts cachedBusLayouts;
    ...
    static AudioProcessor::AudioIOProperties getBusProperties (ComSmartPtr<Vst::IComponent>& component)
    {
